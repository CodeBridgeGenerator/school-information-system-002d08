...
teacherId: _entity?.teacherId,
    ...
    return (
        <Dialog header="Edit Classes" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
